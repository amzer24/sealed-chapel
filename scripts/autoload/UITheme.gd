...
func _build_theme() -> Theme:
	...
	var panel_style := _stylebox(Color(Palette.SOOT, 0.90), Palette.CURSE, 2, 3)
	...
	var btn_normal := _stylebox(Palette.SOOT, Palette.ROT, 2, 3)
	...
	var btn_hover := _stylebox(Palette.BRUISE, Palette.CURSE, 2, 3)
	...
	var btn_pressed := _stylebox(Palette.ROT, Palette.CURSE, 2, 3)
	...
	var btn_focus := _stylebox(Color(0, 0, 0, 0), Palette.CURSE, 2, 3)
	...
	t.set_color("font_hover_color", "Button", Palette.CURSE)
	t.set_color("font_pressed_color", "Button", Palette.CURSE)
	t.set_color("font_focus_color", "Button", Palette.CURSE)
